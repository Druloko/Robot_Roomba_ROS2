...
{
  new (message_memory) roomba_msgs::msg::State(_init);
}

void State_fini_function(void * message_memory)
{
  auto typed_message = static_cast<roomba_msgs::msg::State *>(message_memory);
  typed_message->~State();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember State_message_member_array[3] = {
  {
    ...
    offsetof(roomba_msgs::msg::State, oi_mode),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(roomba_msgs::msg::State, is_charging),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(roomba_msgs::msg::State, battery_charge),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
get_message_type_support_handle<roomba_msgs::msg::State>()
{
  return &::roomba_msgs::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roomba_msgs, msg, State)() {
  return &::roomba_msgs::msg::rosidl_typesupport_introspection_cpp::State_message_type_support_handle;
}
