...
static const _Power_type_support_symbol_names_t _Power_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roomba_msgs, msg, Power)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, roomba_msgs, msg, Power)),
  }
};
...
{
  return &::roomba_msgs::msg::rosidl_typesupport_cpp::Power_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, roomba_msgs, msg, Power)() {
  return get_message_type_support_handle<roomba_msgs::msg::Power>();
}
