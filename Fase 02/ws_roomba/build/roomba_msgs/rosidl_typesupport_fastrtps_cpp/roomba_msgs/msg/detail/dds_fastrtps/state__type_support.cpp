...
#include "roomba_msgs/msg/detail/state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const roomba_msgs::msg::State & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: oi_mode
  cdr << ros_message.oi_mode;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  roomba_msgs::msg::State & ros_message)
{
  // Member: oi_mode
  cdr >> ros_message.oi_mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = roomba_msgs::msg::State;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const roomba_msgs::msg::State *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<roomba_msgs::msg::State *>(
    untyped_ros_message);
...
{
  return &roomba_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, roomba_msgs, msg, State)() {
  return &roomba_msgs::msg::typesupport_fastrtps_cpp::_State__handle;
}
